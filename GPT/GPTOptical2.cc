...
void SolveOCSConfiguration() {
    ...
    // Variables
    //std::vector<std::vector<std::vector<const MPVariable*>>> S(n, std::vector<std::vector<const MPVariable*>>(num_ports, std::vector<const MPVariable*>(num_ports)));
